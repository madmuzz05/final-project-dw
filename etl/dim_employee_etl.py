...
from config_etl import etl_config_dim_employee
...
def run_etl_dim_employee():
    ...
    try:
        ...
        validate_config(etl_config_dim_employee)  # Validate config
        for table_name, table_config in etl_config_dim_employee.items():
